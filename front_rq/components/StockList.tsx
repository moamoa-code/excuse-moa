...
import { Image, Card, message, Empty, Typography, Table, Button, Divider, Form, Popconfirm } from 'antd';
import dayjs from 'dayjs';
import { loadPostAPI } from '../apis/post';
import styled from 'styled-components';
import { FileExcelOutlined } from '@ant-design/icons';
import { Block, CenteredDiv, FormBox, HGap, Red } from './Styled';
import { useMediaQuery } from 'react-responsive';
import { createStockAPI, deleteStockAPI, getSotcksAPI } from '../apis/inventory';
...
const StockList = (props) => {
  const { user, setSelectedStock, selectStock } = props;
  ...
  if (mode === 'LIST') return (
    <>
      ...
      <HGap />
      <Button onClick={()=>{setMode('CREATE')}} type='primary'>+ 새로운 품목 추가</Button>
      <br />
    </>
  )
