...
const Intro = () => {
  ...
  const slideTitleStyle = useMemo(() => ({ fontSize: "19pt" }), []);
  const slideDescStyle = useMemo(() => ({ fontSize: "13pt" }), []);
      ...
      {content === "intro" ? (
        <IntroContainer>
          <div className="section">
            ...
            <h1>B2B 원두커피 주문관리 시스템</h1>
            <h2>
              소규모 사업자 원두커피 주문 관리에 최적화된 시스템!
              <br />
              복잡한 ERP나 수기장부는 이제 그만, 꼭 필요한 기능만 담았습니다.
              <br />
              간편하게 원두커피를 주문 해 보세요.
            </h2>
          </div>
            ...
            <div className="section feature" ref={divRef} key={1}>
              <Slider {...sliderSettings}>
                <div>
                  ...
                  <p style={slideDescStyle}>
                    스프레드시트 스타일로 편리하게 회원 일괄생성
                  </p>
                </div>
                <div>
          ...
          <div className="section ">
            ...
            <div className="mobile_mockup">
              <div className="mock">
                ...
                {mokeupImgsTurn === 1 ? (
                  <div
                    className="frame animateImg"
                    key={1}
                    onAnimationEnd={mobileAnimationEnd}
                  >
          ...
          <div className="section grey">
            <h1>판매회원 혹은 구매회원으로 시작해 보세요.</h1>
            <button className="button" onClick={() => setContent("customer")}>
              구매회원
            </button>
            <br />
            <button className="button" onClick={() => setContent("provider")}>
              판매회원
            </button>
          </div>
          <div className="section">
            ...
            <HGap />
            <h2>원활한 서비스 이용을 위해 크롬 브라우저 이용을 권장합니다.</h2>
            <HGap />
            <a href="https://www.google.co.kr/chrome/" target="_blank">
              <button className="button">크롬설치</button>
            </a>
          </div>
        </IntroContainer>
      ) : content === "customer" ? (
        <IntroContainer>
          <div className="section">
            ...
            <HGap />
            <button className="button" onClick={() => setContent("intro")}>
              뒤로가기
            </button>
          </div>
        </IntroContainer>
        ...
        <IntroContainer>
          <div className="section">
            ...
            <p>
              ...
              따로 회원가입으로 가입한 고객을 판매자의 회원으로 등록할 수
              있습니다.
            </p>
          </div>
          <div className="section">
          ...
          <div className="section">
            <h1>고객 맞춤 관리</h1>
            <p>구매자별로 노출가능한 제품, 공지사항을 설정 할 수 있습니다.</p>
            <HGap />
            <button className="button" onClick={() => setContent("intro")}>
              뒤로가기
            </button>
