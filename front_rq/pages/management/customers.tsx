...
import {
  ...
  Input, message, notification, Popconfirm, Space, Table, Tag, Typography
} from "antd";
...
import {
  addCustomerAPI, addItemToCustomerAPI, addNewAddrAPI, changePasswordAPI, deleteCustomerAPI, loadAddrsAPI, loadMyInfoAPI,
  loadUserAPI, removeAddrAPI, removeItemToCustomerAPI, terminateUserAPI, updateUserAPI
} from "../../apis/user";
...
const Customers = () => {
  ...
  // 아이디 유효성검사
  const onChangeUKey = useCallback(
    (e) => {
  ...
  const userTableColumns = [
    ...
    },
    {
      ...
      type: "right",
      render: (text, record) => (
        <span onClick={onViewUserInfo(record.key)} style={{ color: "#4aa9ff" }}>
          보기
        </span>
      ),
    },
  ...
  return (
    <AppLayout>
      <Container800>
        ...
        <Search
          placeholder="사업자 등록번호(아이디) 정확히 입력"
          onSearch={onSearch}
          enterButton
        />
        {isVisible ? (
          <>
            ...
            <DataShow ref={divRef}>
              ...
              <div className="container">
                ...
                <span className="data">
                  {isEditable ? (
                    ...
                    <input value={uKey} onChange={onChangeUKey} disabled />
                  )}
                </span>
              </div>
              <div className="container">
              ...
              <div className="container">
                ...
                <span className="data">
                  {isEditable ? (
                    ...
                    <input value={uName} onChange={onChangeUname} disabled />
                  )}
                </span>
              </div>
              <div className="container">
                ...
                <span className="data">
                  {isEditable ? (
                    ...
                    <input value={uPhone} onChange={onChangeUphone} disabled />
                  )}
                </span>
              </div>
              <div className="container">
                ...
                <span className="data">
                  {isEditable ? (
                    ...
                    <input value={uEmail} onChange={onChangeUemail} disabled />
                  )}
                </span>
              </div>
              <div className="container">
              ...
              <div className="container">
                ...
                <span className="data">
                  <Button
                    disabled={!isMine}
                    onClick={() => setIsCustomerOrdersModal(true)}
                  >
                    구매주문
                  </Button>
                </span>
            ...
            {isEditable ? (
              <Button loading={loading} type="primary" onClick={onReqUserEdit}>
                회원정보 수정
              </Button>
            ) : isMine ? (
              <Space wrap>
              ...
              <Button onClick={onAddCustomer} loading={loading}>
                내 고객으로 등록
              </Button>
            )}
            {isEditAddr ? (
              <div>
                ...
                <Space wrap>
                  {addrs?.map((v) => {
                    ...
                    return (
                      <Button type="dashed" onClick={onAddrSelectClick(v)}>
                        {v.addrName}
                      </Button>
                    );
                  })}
