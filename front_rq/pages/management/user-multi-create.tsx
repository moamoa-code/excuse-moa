...
import { loadMyInfoAPI, loadUserAPI, loadProvidersAPI, createUsersAPI } from '../../apis/user';
...
export const getServerSideProps = async (context: GetServerSidePropsContext) => {
  ...
  if ( response.role !== 'PROVIDER') { // 관리자권한
    return {
      redirect: {
        destination: '/unauth',
        permanent: false,
...
export default UserMultiCreate;
