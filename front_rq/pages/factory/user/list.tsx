    ...
    <AppLayout>
      <ContainerWide>
        ...
        <SearchBlock>
          ...
          <button type="button" onClick={() => onLoadAllUsers(page)}>
            전체목록
          </button>
        </SearchBlock>
          ...
          <div id={"editForm"} ref={divRef}>
            ...
            <Descriptions style={{ marginTop: "30px" }} bordered>
              ...
              <Descriptions.Item label="아이디/사업자번호" span={2}>
                {isEditable ? (
                  <input value={uKey} onChange={onChangeUKey} />
                ) : (
              ...
              <Descriptions.Item label="회사명" span={2}>
                {isEditable ? (
                  <input value={uCompany} onChange={onChangeUcompany} />
                ) : (
                  <input
                    value={uCompany}
              ...
              <Descriptions.Item label="담당자 성함" span={2}>
                {isEditable ? (
                  <input value={uName} onChange={onChangeUname} />
                ) : (
              ...
              <Descriptions.Item label="담당자 전화번호" span={2}>
                {isEditable ? (
                  <input value={uPhone} onChange={onChangeUphone} />
                ) : (
              ...
              <Descriptions.Item label="담당자 이메일" span={2}>
                {isEditable ? (
                  <input value={uEmail} onChange={onChangeUemail} />
                ) : (
              ...
              <Descriptions.Item label="회원구분" span={2}>
                <Space>
                  <Select onChange={handleRoleChange} defaultValue={uRole}>
              ...
              <Descriptions.Item label="주문목록" span={2}>
                <Space>
                  <Button onClick={() => setIsCustomerOrdersModal(true)}>
                    구매주문
                  </Button>
                  <Button onClick={() => setIsProviderOrdersModal(true)}>
                    판매주문
                  </Button>
                </Space>
              </Descriptions.Item>
