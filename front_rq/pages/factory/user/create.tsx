...
import {
  Breadcrumb, Button, Form, message, notification, Select, Typography
} from "antd";
...
import {
  createUserAPI, loadMyInfoAPI, loadProvidersAPI, loadUserAPI
} from "../../../apis/user";
        ...
        <Form onFinish={onSubmit} form={form}>
          ...
          {role === "CUSTOMER" ? (
            <>
              ...
              <SearchBlock>
                <div>
                  <input value={searchTxt} onChange={onChangeSearchTxt} />
                  <button
                    type="button"
                    className="search"
