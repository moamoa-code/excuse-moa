...
import {
  Button, Form,
  Input, message, notification, Select, Typography
} from "antd";
  ...
  return (
    <AppLayout>
      <ContainerMid>
        ...
        <FormBox>
          <Form style={{ margin: "30px 0 20px 0" }} onFinish={onSubmit}>
            <Block>
              <label>
                <Red>* </Red>게시글 열람가능 고객 범위
              </label>
              <Select onChange={handleScopeChange} defaultValue={"GROUP"}>
