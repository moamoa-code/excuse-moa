...
import {
  Button, Divider, message, Modal, Popconfirm, Space, Typography
} from "antd";
...
import {
  createInventoryAPI, getInventoryDataAPI,
...
const UpdateInventory = () => {
  ...
  const { data: inventoryData } = useQuery(["inventoryData", id], () =>
    getInventoryDataAPI(Number(id))
  );
    ...
    for (let i = 0; i < stockInputs?.length; i++) {
      ...
      if (stockInputs[i].unit === "") {
        ...
        return message.error(
          `'${stockInputs[i].stockName}'의 단위를 입력해 주세요.`
        );
      }
    }
    if (!error) {
  ...
  return (
    <AppLayout>
      <ContainerWide>
        ...
        >
          <StockList user={myUserInfo} selectStock={selectStock} />
          <br />
        </Modal>
        <Modal
          ...
          width={680}
          footer={[
            <Button onClick={() => setIsViewModalVisible(false)}>닫기</Button>,
          ]}
        >
          <div>
            {stockInputs[selectedStockIndex] !== undefined &&
            stockInputs[selectedStockIndex] !== null ? (
              <StockViewModal>
                <h1>{stockInputs[selectedStockIndex].stockName}</h1>
                <p>{stockInputs[selectedStockIndex]?.desc}</p>
                <div>
                  {locArray.indexOf(
                    stockInputs[selectedStockIndex].location
                  ) === -1 ? (
                    <div className="selectWrap">
                      ...
                      <input
                        ...
                        onChange={(e) =>
                          handleInputChange(e, selectedStockIndex)
                        }
                        maxLength={10}
                        autoComplete="off"
                        required
                      ...
                      <button
                        onClick={(e) =>
                          onModifyInput("location", selectedStockIndex, "A")
                        }
                      >
                        <MoreOutlined />
                      </button>
                    ...
                    <div className="selectWrap">
                      ...
                      <button
                        onClick={(e) =>
                          onModifyInput("location", selectedStockIndex, "")
                        }
                      >
                        <MoreOutlined />
                      </button>
                ...
                <div>
                  {unitArray.indexOf(stockInputs[selectedStockIndex].unit) ===
                  -1 ? (
                    <div className="selectWrap">
                      <span>단위: </span>
                      <input
                      ...
                      <button
                        onClick={(e) =>
                          onModifyInput("unit", selectedStockIndex, "개")
                        }
                      >
                        <MoreOutlined />
                      </button>
                    ...
                    <div className="selectWrap">
                      ...
                      <button
                        onClick={(e) =>
                          onModifyInput("unit", selectedStockIndex, "")
                        }
                      >
                        <MoreOutlined />
                      </button>
                ...
                <div>
                  {statusArray.indexOf(
                    stockInputs[selectedStockIndex].status
                  ) === -1 ? (
                    <div className="selectWrap">
                      <span>상태: </span>
                      <input
                      ...
                      <button
                        onClick={(e) =>
                          onModifyInput("status", selectedStockIndex, "OK")
                        }
                      >
                        <MoreOutlined />
                      </button>
                    ...
                    <div className="selectWrap">
                      ...
                      <button
                        onClick={(e) =>
                          onModifyInput("status", selectedStockIndex, "")
                        }
                      >
                        <MoreOutlined />
                      </button>
                ...
                <div>
                  ...
                  <div className="qtyInputBox">
                    <button onClick={(e) => minusQty(selectedStockIndex)}>
        ...
        <Divider>
          <Title level={4}>{inventoryGroup?.name} 재고 보고서 갱신</Title>
        </Divider>
        <HGap />
        <UserInfoBox userInfo={myUserInfo} />
        <HGap />
        <HGap />
        <FormBox>
          <Block>
            <label>이름</label>
            <input value={inventoryGroup?.name} disabled />
          </Block>
          <Block>
            <label>설명</label>
            <input value={inventoryGroup?.desc} disabled />
          </Block>
        </FormBox>
        <HGap />
        <HGap />
                        ...
                        <div className="container" key={i}>
                          <div className="top">
                            ...
                            <div className="action">
                              <div className="qtyInputBox">
                                <button onClick={(e) => minusQty(i)}>
                                  <MinusOutlined style={minusButtonStyle} />
                                </button>
                                <button name="qty" onClick={(e) => plusQty(i)}>
                                  <PlusOutlined style={plusButtonStyle} />
                                </button>
                              </div>
                            </div>
                          ...
                          <div className="bottom">
                            ...
                            {unitArray.indexOf(v.unit) === -1 ? (
                              ...
                              <div className="selectWrap">
                                ...
                                <button
                                  onClick={(e) => onModifyInput("unit", i, "")}
                                >
                                  <MoreOutlined />
                                </button>
                              </div>
                    ...
                    if (v.stockType === type) {
                      return (
                        <tr>
                          ...
                          <td>
                            {unitArray.indexOf(v.unit) === -1 ? (
                              ...
                              <div className="selectWrap">
                                ...
                                <button
                                  onClick={(e) => onModifyInput("unit", j, "")}
                                >
                                  <MoreOutlined />
                                </button>
                              </div>
                          ...
                          <td>
                            <div className="qtyInputBox">
                              <button onClick={(e) => minusQty(j)}>
                                <MinusOutlined style={minusButtonStyle} />
                              </button>
                              <button name="qty" onClick={(e) => plusQty(j)}>
                                <PlusOutlined style={plusButtonStyle} />
                              </button>
                            </div>
                          </td>
        ...
        <HGap />
        <Button type="primary" onClick={onAddField} loading={loading}>
          + 품목 추가
        </Button>
        <HGap />
        <FormBox>
        ...
        <HGap />
        <Space wrap>
          <Link href={`/inventory/report/${inventoryGroup?.id}`}>
