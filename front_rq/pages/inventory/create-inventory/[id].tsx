  ...
  return (
    <AppLayout>
      <ContainerWide>
        ...
        <Divider>
          <Title level={4}>새로운 재고 보고서 작성</Title>
        </Divider>
        <FormBox>
          <Block>
            <label>이름</label>
        ...
        <InputFormTable>
          ...
          {stockInputs?.map((x, i) => {
            return (
              <tr>
                <td>
                  <input name="stockName" value={x.stockName} disabled />
                </td>
                <td>
                  <input name="stockType" value={x.stockType} disabled />
                </td>
                <td>
                  {locArray.indexOf(x.location) === -1 ? (
                    <div className="selectWrap">
                      ...
                      />
                      <button
                        onClick={(e) => onModifyInput("location", i, "A")}
                      >
                        <MoreOutlined />
                      </button>
                    </div>
                    ...
                    <div className="selectWrap">
                      ...
                      <button onClick={(e) => onModifyInput("location", i, "")}>
                        <MoreOutlined />
                      </button>
                    </div>
                  )}
                  ...
                  {unitArray.indexOf(x.unit) === -1 ? (
                    <div className="selectWrap">
                      <input
                        ...
                        required
                      />
                      <button onClick={(e) => onModifyInput("unit", i, "개")}>
                        <MoreOutlined />
                      </button>
                    </div>
                  ) : (
                    <div className="selectWrap">
                      ...
                      <button onClick={(e) => onModifyInput("unit", i, "")}>
                        <MoreOutlined />
                      </button>
                    </div>
                  )}
                  ...
                  {statusArray.indexOf(x.status) === -1 ? (
                    <div className="selectWrap">
                      <input
                        ...
                        required
                      />
                      <button onClick={(e) => onModifyInput("status", i, "OK")}>
                        <MoreOutlined />
                      </button>
                    </div>
                  ) : (
                    <div className="selectWrap">
                      ...
                      <button onClick={(e) => onModifyInput("status", i, "")}>
                        <MoreOutlined />
                      </button>
                    </div>
                  )}
                ...
                <td>
                  <Button danger onClick={onRemoveField(i)} loading={loading}>
                    제거
                  </Button>
                </td>
              </tr>
        ...
        <Block>
          <label>메모</label>
          <input value={memo} onChange={onChangeMemo} maxLength={99} />
        </Block>
        <Space>
...
export const getServerSideProps = async (
  ...
  await queryClient.prefetchQuery(["inventoryGroup", id], () =>
    getInventoryGroupAPI(Number(id))
  );
  return {
    props: {
