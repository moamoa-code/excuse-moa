...
import {
  Button, Descriptions, Divider, message, Result, Space, Spin
} from "antd";
...
import { loadCustomerItemListAPI } from "../../apis/item";
import { orderPosItemAPI } from "../../apis/order";
import {
  loadAddrsAPI,
  loadMyInfoAPI, loadProviderByIdAPI
} from "../../apis/user";
    ...
    <AppLayout>
      <Container800>
        ...
        <Divider orientation="left">
          <TiTle>1. 판매자/브랜드 정보</TiTle>
        </Divider>
        <UserInfoBox userInfo={selectedProviderData} />
        <HGap />
        <HGap />
        <Divider orientation="left">
          <TiTle>2. 구매자 정보</TiTle>
        </Divider>
            ...
            <ItemForm>
              <div>
                <div style={{ textAlign: "center" }}>
                  <WarningTwoTone /> 판매자와 사전협의되지 않은 제품 입력시
                  주문이 취소될 수 있습니다.
                </div>
